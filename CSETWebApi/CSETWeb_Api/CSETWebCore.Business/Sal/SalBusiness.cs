...
namespace CSETWebCore.Business.Sal
{
    public class SalBusiness : ISalBusiness
    {
        ...
        /// TSA's default level
        /// </summary>
        public static readonly string DefaultSalTsa = "Низький";
        ...
        /// </summary>
        /// <param name="assessmentId"></param>
        public void SetDefaultSALs(int assessmentId, string level = "Низький")
        {
        ...
        /// </summary>
        /// <param name="assessmentId"></param>
        public void SetDefault(int assessmentId, string level = "Низький")
        {
