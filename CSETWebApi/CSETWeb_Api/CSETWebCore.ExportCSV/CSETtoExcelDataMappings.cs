...
namespace CSETWebCore.ExportCSV
{
    public class CSETtoExcelDataMappings
    {
        ...
        public void ProcessTables(MemoryStream stream)
        {
            ...
            versionList.Add(v);
            doc.AddList<VersionExport>(versionList, "¬ÂÒ≥ˇ", null);
        ...
        private void CreateWorksheetPageStandardAnswers(ref CSETtoExcelDocument doc)
        {
            ...
            if (applicationMode.ToLower().Contains("questions"))
            {
                ...
                list = from a in answers
                       ...
                       select new QuestionExport()
                       {
                           ...
                           Answer_Text = getLocalizedAnswer(a.Answer_Text),
                           Mark_For_Review = a.Mark_For_Review == true ? "“¿ " : "Õ≤",
                           Reviewed = a.Reviewed == true ? "“¿ " : "Õ≤",
                           Is_Requirement = a.Is_Requirement == true ? "“¿ " : "Õ≤",
                           Is_Maturity = a.Is_Maturity == true ? "“¿ " : "Õ≤",
                           Is_Component = a.Is_Component == true ? "“¿ " : "Õ≤",
                           Is_Framework = a.Is_Framework == true ? "“¿ " : "Õ≤",
                           Comment = a.Comment,
                ...
                rows.ForEach(q =>
                {
                    q.Is_Question = !((q.Is_Requirement == "“¿ ") || (q.Is_Component == "“¿ ") || (q.Is_Maturity == "“¿ ") || (q.Is_Framework == "“¿ ")) ? "“¿ " : "Õ≤";
                });

                doc.AddList<QuestionExport>(rows, "—Ú‡Ì‰‡ÚÌ≥ ÔËÚ‡ÌÌˇ", QuestionExport.Headings);
            }
            ...
            if (applicationMode.ToLower().Contains("requirements"))
            {
                ...
                doc.AddList<QuestionExport>(rows, "—Ú‡Ì‰‡ÚÌ≥ ‚ËÏÓ„Ë", QuestionExport.Headings);
            }
        }
        ...
        private void CreateWorksheetPageMaturityAnswers(ref CSETtoExcelDocument doc)
        {
            ...
            doc.AddList<QuestionExport>(rows, "œËÚ‡ÌÌˇ Á≥ÎÓÒÚ≥", QuestionExport.Headings);
        }
        ...
        private void CreateWorksheetPageDiagramAnswers(ref CSETtoExcelDocument doc)
        {
            ...
            doc.AddList<QuestionExport>(rows, "œËÚ‡ÌÌˇ ÍÓÏÔÓÌÂÌÚ≥‚", QuestionExport.Headings);
        }
        ...
        private void CreateWorksheetPageFrameworkAnswers(ref CSETtoExcelDocument doc)
        {
            ...
            doc.AddList<QuestionExport>(qlist.ToList<QuestionExport>(), "—ÚÛÍÚÛ‡", QuestionExport.Headings);
        }
        ...
        private string getLocalizedAnswer(string answer)
        {
            switch (answer)
            {
                case "A":
                    return "¿Î¸ÚÂÌ‡ÚË‚Ì‡ ‚≥‰ÔÓ‚≥‰¸";
                case "Y":
                    return "“‡Í";
                case "N":
                    return "Õ≥";
    ...
    public class QuestionExport
    {
        ...
        public String? Mark_For_Review { get; set; }
        public String? Reviewed { get; set; }
        public String? Is_Question { get; set; }
        public String? Is_Requirement { get; set; }
        public String? Is_Maturity { get; set; }
        public String? Is_Component { get; set; }
        public String? Is_Framework { get; set; }
    ...
    {
        private static string[] headings = new string[] { "¬ÂÒ≥ˇ" };
