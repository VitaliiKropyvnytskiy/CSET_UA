...
namespace CSETWebCore.Interfaces.Analytics
{
    ...
    {
        List<AnalyticsMinMaxAvgMedianByGroup> getMaturityDashboardData(int maturity_model_id,int? sectorId, int? industryId, int? mainServiceTypeId);
        ...
        List<AnalyticsStandardMinMaxAvg> GetStandardMinMaxAvg(int assessmentId, string setname, int? sectorId, int? industryId, int? mainServiceTypeId);
