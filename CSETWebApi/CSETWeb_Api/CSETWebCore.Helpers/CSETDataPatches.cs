...
namespace CSETWebCore.Helpers
{
    internal class CSETDataPatches
    {
        ...
        public void UpdatePatches(CSETContext context)
        {
            ...
            "INSERT INTO [dbo].[MATURITY_MODELS] ([Maturity_Model_Id], [Model_Name], [Questions_Alias], [Answer_Options]) VALUES (4, 'CRR', 'Практики', 'Y,I,N')\n" +
            "if (not exists (select * from maturity_models where Maturity_Model_Id = 5))\n" +
            "INSERT INTO [dbo].[MATURITY_MODELS] ([Maturity_Model_Id], [Model_Name], [Questions_Alias], [Answer_Options]) VALUES (5, 'RRA', 'Практики', 'Y,N')\n" +
