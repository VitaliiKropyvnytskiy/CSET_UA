...
namespace CSETWebCore.Helpers.ReportWidgets
{
    public class PerformanceSummaryLegend
    {
        ...
        public PerformanceSummaryLegend(string configuration = "")
        {
            ...
            yellow_line_text1.Value = "частково виконані";
            yellow_line_text2.Value = "практики";
            ...
            red_line_text1.Value = "не виконані";
            red_line_text2.Value = "практики";
            ...
            yes_line_text1.Value = "відсоток";
            yes_line_text2.Value = "відповідей «так»";
