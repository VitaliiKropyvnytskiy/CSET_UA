...
namespace CSETWebCore.Helpers.ReportWidgets
{
    public class MIL1PerformanceLegend
    {
        ...
        public MIL1PerformanceLegend()
        {
            ...
            var title = new XElement("text", CreateElement("Легенда", 0, 10, null));
            title.SetAttributeValue("class", "bold");

            int colorLegend_x = 12;
            int colorLegend_y = 23;
            var colorLegend = new XElement("text",
            CreateElement("= Виконано", colorLegend_x, colorLegend_y, null),
            CreateElement("= Частково виконано", colorLegend_x, colorLegend_y + 12, null),
            CreateElement("= Не виконано", colorLegend_x, colorLegend_y + 2 * 12, null)
            );
            ...
            CreateElement("Q1 = Номер питання", questionLegend_x, questionLegend_y, null),
            CreateElement("1P = Номер питання, Актив людей", questionLegend_x, null, "1.2em"),
            CreateElement("1I = Номер питання, Актив інформації", questionLegend_x, null, "1.2em"),
            CreateElement("1T = Номер питання, Актив технології", questionLegend_x, null, "1.2em"),
            CreateElement("1F = Номер питання, Актив об'єктів", questionLegend_x, null, "1.2em")
            );
