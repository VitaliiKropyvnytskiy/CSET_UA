...
namespace CSETWebCore.Helpers.ReportWidgets
{
    ...
    public class BlockLegend
    {
        ...
        public BlockLegend(bool includeGoal = true)
        {
            ...
            var title = new XElement("text", CreateElement("Легенда", 0, 15, null));
            ...
            CreateElement("= Частково виконано", colorLegend_x + 80, colorLegend_y, null),
            CreateElement("= Не виконано", colorLegend_x + 205, colorLegend_y, null)
            );
            ...
            {
                questionLegend.Add(
                    CreateElement("G1 = Номер цілі", questionLegend_x + 105, questionLegend_y, null));
            }
