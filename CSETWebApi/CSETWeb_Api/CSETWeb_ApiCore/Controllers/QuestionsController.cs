...
namespace CSETWebCore.Api.Controllers
{
    ...
    public class QuestionsController : ControllerBase
    {
        ...
        public QuestionsController(ITokenManager token, INotificationBusiness notification,
            ...
            IAdminTabBusiness adminTabBusiness, IUserBusiness user, CSETContext context, IMaturityBusiness maturityBusiness)
        {
            _token = token;
            _context = context;
        ...
        public IActionResult RenameDocument([FromQuery] int document_id, [FromQuery] int? answer_id, [FromQuery] string title, [FromQuery] int question_id, [FromQuery] string questionType)
        {
            var assessmentId = _token.AssessmentForUser();
            _document.SetUserAssessmentId(assessmentId);
            _document.RenameDocument(document_id, answer_id, title, question_id, questionType, _maturityBusiness, _questionRequirement);
            return Ok();
        }
