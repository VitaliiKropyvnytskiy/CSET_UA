  ...
  generatePdf() {
    ...
    for (let i = 0; i < this.contactCount; i++) {
      let pageContent = [
        ...
        {
          text: `Власник оцінювання :    _________________________`,
          style: 'label',
          margin: [0, 10, 10, 10]
        },
        {
        ...
        {
          text: `Тип організації : _________________________`,
          style: 'label',
          margin: [0, 10, 10, 10]
        },
      ...
      content: [
        ...
        { text: `KEY : ${authKey}`, style: 'key', margin: [0, 10, 10, 10] },
        {
          columns: [
            {
              width: '50%',
              text: `Назва оцінювання :______________________________`,
              style: 'labelKey',
              margin: [0, 0, 0, 0]
            },
            // {
        ...
        { text: `Власник оцінювання :`, style: 'label', margin: [0, 10, 10, 10] },
